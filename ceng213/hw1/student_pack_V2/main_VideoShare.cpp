...
int main(int argc, char* argv[]) {
    ...
    // is connected ?
        // vs1.addFriendship("userName284", "userName450");
        // vs1.addFriendship("userName450", "userName341");
        // vs1.addFriendship("userName450", "userName056");
        // vs1.addFriendship("userName284", "userName056");
        // vs1.addFriendship("userName056", "userName341");
        // vs1.addFriendship("userName200", "userName056");
        // vs1.addFriendship("userName051", "userName056");
        // vs1.addFriendship("userName051", "userName127");
        // vs1.addFriendship("userName051", "userName311");
        // vs1.addFriendship("userName127", "userName311");
        // vs1.addFriendship("userName341", "userName392");

        // cout << vs1.isConnected ("userName284", "userName341312312") << endl;
        // return 0;
    // is connected !
